package com.dxe.squirrel.common.config;
...
@PropertySource(value = {"${encrypt.file:classpath:config/encrypted.properties}"})
public class EncryptConfig implements EnvironmentAware {
    ...
    private StringEncryptor stringEncryptor() {
        ...
        config.setPassword(getProperty(environment, "jasypt.encryptor.password", ""));
        config.setAlgorithm(getProperty(environment, "jasypt.encryptor.algorithm", ""));
